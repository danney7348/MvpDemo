package com.bwie.lianxi0927.zhifubao;
...
import com.bwie.lianxi0927.presenter.UpdateOrderPresenter;
...
PayDemoActivity extends FragmentActivity implements UpdateOrderView {
...
//	private static final String URL_JSON = "http://169.254.63.148:8080/alipayServer/AlipayDemo";
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    String orderidStr = intent.getStringExtra("orderid");
                    int orderid = Integer.parseInt(orderidStr);
                    if (TextUtils.equals(resultStatus, "9000")) {
                        presenter = new UpdateOrderPresenter(PayDemoActivity.this,PayDemoActivity.this);
                        presenter.requestUpdateOrder(getSharedPreferences("con",MODE_PRIVATE).getInt("uid",170),1,orderid);
                        Toast.makeText(PayDemoActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        Intent intent1 = new Intent(PayDemoActivity.this,ZhuActivity.class);
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            ...
                            presenter.requestUpdateOrder(getSharedPreferences("con",MODE_PRIVATE).getInt("uid",170),0,orderid);
                        } else {
                            // 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
                            Toast.makeText(PayDemoActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                            presenter.requestUpdateOrder(getSharedPreferences("con",MODE_PRIVATE).getInt("uid",170),2,orderid);
                        }
                    }
                    break;
                }
    ...
    private IWXAPI api;
    private UpdateOrderPresenter presenter;
...
//        paySignFromServer();
    ...
    @Override
    public void onUpdateOrderSuccess(final String msg) {
